...
def validate(val_loader, model, epoch, exp, mant, type, output_directory=""):
    ...
    for i, sample_batched in enumerate(val_loader):
        ...
        if i == 0:
            ...
            filename = output_directory + '/comparison_quant_act_' + str(epoch) + '_exp_' + str(exp) + '_mant_' + str(mant) + '_' + str(type) + '.png'
...
def main():
    ...
    with open("./results/results_act_{}_.csv".format(args.dtype),'w',newline='', encoding = 'utf-8') as f:
        writer = csv.writer(f)
