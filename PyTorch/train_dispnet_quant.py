...
from model import PTModel, DispNetS, DispNetS_Q
from loss import ssim
from data import getTrainingTestingData
from utils import AverageMeter, DepthNorm, colorize, init_or_load_model_quant
from quant import *
def main():
    # Arguments
    ...
    if len(args.checkpoint) > 0:
        ...
        model, optimizer, start_epoch = init_or_load_model_quant(
            depthmodel=DispNetS_Q,
            epochs=args.epochs,
            lr=args.lr,
    ...
    batch_size = args.bs
    prefix = 'dispnet_quant_' + str(batch_size)
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        for i, sample_batched in enumerate(train_loader):
            ...
            if i % 1000 == 0:
                ...
                args.save + "ckpt_{}_quant.pth".format(epoch, int(losses.avg * 100)),
                )   
